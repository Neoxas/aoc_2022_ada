...
package Days.Day_10 with SPARK_Mode is
   ...
   subtype Crt_Line_T is String( 1 .. 40 );
   ...
   function Get_Crt_Screen( Instructions : Cpu_Inst_Vec_P.Vector; Interesting_Times : Intersting_Cycles_Arr_T ) return Crt_Screen_Arr_T;
end Days.Day_10;
