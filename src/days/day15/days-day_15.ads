...
package Days.Day_15 with SPARK_Mode is
   ...
   subtype Restricted_Col_Idx is Integer range 0 .. 4_000_000;
   subtype Restricted_Row_Idx is Integer range 0 .. 4_000_000;
   ...
   type Beacon_Arr_T is array( Restricted_Row_Idx, Restricted_Col_Idx ) of Beacon_Grid_E;
   type Beacon_Arr_A is access Beacon_Arr_T;
   
   procedure Add_Beacons_To_Grid( Scan_Entries: Scan_Results_P.Vector; Grid: Beacon_Arr_A );

   function Count_Not_Empty_Entries_In_Row( Grid: Beacon_Arr_A; Row_To_Check: Beacon_Row_Idx ) return Natural;
end Days.Day_15;
